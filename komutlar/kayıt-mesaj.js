...
module.exports.run = async (client, message, args) => {
  if(db.fetch(`gold_${message.author.id}`)!="acik"){ 
      message.channel.send("Bu komutu sadece **Gold Üyeler** kullanabilir!")
      return;
  }
...
.addField(`URL'sini Ayarlamak İçin`, ` \`${prefix}k-mesaj url discordlink örnek. \` `, true)
  .addField('** **','** **')
.addField(`Başlığını Ayarlamak İçin`, ` \`${prefix}k-mesaj başlık Ceixsa Bot Kayıt Sistemi örnek. \` `, true)
