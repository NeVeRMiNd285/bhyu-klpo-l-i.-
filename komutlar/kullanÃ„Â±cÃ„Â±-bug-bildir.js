...
let channel = client.channels.cache.get("807939924430159872")//bug repot kanal id'i
let embed = new Discord.MessageEmbed()
.setTitle("Ceixsa Bot Bug Report")
...
.setColor("#ff4400")
channel.send(embed)
message.channel.send("Bug başarıyla kanala iletildi.")
message.react("⏳")
