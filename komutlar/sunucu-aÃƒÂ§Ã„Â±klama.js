...
exports.run = async(client, message, args) => {    
  ...
  if (!message.member.hasPermission("MANAGE_CHANNELS")) return message.reply('Bunun için **Kanalları_Yönet** yetkisine sahip olman gerek.');
  ...
  .then(newChannel => message.channel.send(
    ...
    .setDescription(`Bu kanalın yeni konusu ***${args}***`)))
  .catch(console.error);
};
