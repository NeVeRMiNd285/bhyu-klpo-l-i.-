...
exports.run = async (client, message, args) => { 
  ...
  if(!modlogs) {
      ...
      .setColor("RANDOM")
      .setDescription(`**Bu sunucuda daha önceden modlog kanalı ayarlanmamış. Ayarlamak için:** \`${prefix}mod-log <#kanal>\``)
    ...
    if(modlogs) {    
      ...
      .setColor("RANDOM")
      .setDescription(`**Modlog kanalı başarılı bir sıfırlandı!**`)
