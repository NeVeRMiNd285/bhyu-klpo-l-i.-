 ...
 let modlogs = db.get(`modlogkanaly_${message.guild.id}`)
  ...
  if(!modlogs) {
    ...
    const modlogkanal = message.guild.channels.cache.find(kanal => kanal.id === modlogs);
      ...
      .setColor("RANDOM")
      .setDescription(`**Modlog kanalı başarılı bir şekilde ayarlandı.**`)
      ...
      .setColor("RANDOM")
      .setDescription(`**Bu sunucuda daha önceden modlog kanalı ayarlanmış. Sıfırlamak için:** \`${prefix}mod-log-sıfırla\`\n**Ayarlanan kanal:** \`${modlogkanal.name}\``)
