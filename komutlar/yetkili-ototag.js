...
exports.run = async (client, message, args, member) => {
    ...
    .addField('Sadece herhangi bir sunucudan mesaj gönderebilirim.')
    return message.author.sendEmbed(ozelmesajuyari); }
     ...
     let mesaj = args.join(' ');
     if (!mesaj) return message.channel.send("Ototag ayarlamak için bir değer belirtmelisiniz.  `cx.ototag || cx. `"); 
