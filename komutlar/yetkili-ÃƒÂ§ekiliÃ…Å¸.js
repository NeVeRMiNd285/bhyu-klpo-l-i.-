            ...
            msg.edit('**Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " Ceixsa Bot Çekiliş Sistemi", message.author.avatarURL);
                  message.guild.channels.cache.find(x => x.name ===  room).send('**ÇEKİLİŞ BAŞLADI**' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("Ceixsa Bot çekiliş sistemi")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.MessageEmbed()
                        .setColor("RANDOM")
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("Ceixsa Bot Çekiliş Sistemi")
