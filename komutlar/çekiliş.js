...
if(!args[0]) return message.channel.send(`Bir argüman girmelisin: cx.çekiliş başlat/tekrar`)
let arg = ['başlat', 'tekrar']
if(!arg.includes(args[0])) return message.channel.send(`Sadece cx.çekiliş başlat/tekrar kullanabilirsin.`)
